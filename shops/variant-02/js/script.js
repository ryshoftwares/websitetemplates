...
(function () {
  ...
  var CART_KEY = "crate-cart-count";
  var WISHLIST_KEY = "crate-wishlist";
  ...
  /* ---- offers/home page: newsletter signup validation ---- */
  ...
  if (newsletterForm) {
    newsletterForm.addEventListener("submit", function (e) {
      ...
      note.textContent = "You're in — welcome to the CRATE crew.";

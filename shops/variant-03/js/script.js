/* ==========================================================================
   The Goods Shop — Minimal Professional
...
(function () {
  ...
  var CART_KEY = "goods-shop-cart-count";
  var WISHLIST_KEY = "goods-shop-wishlist";
  ...
  if (newsletterForm) {
    newsletterForm.addEventListener("submit", function (e) {
      ...
      note.textContent = "You're subscribed — welcome to The Goods Shop.";

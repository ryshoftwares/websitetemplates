...
(function () {
  ...
  /* ---- pointer-driven tilt on hover for floating hero art ---- */
  ...
  /* ---- generic validated form handling (donor form, etc.) ---- */
  ...
  var frequencyButtons = document.querySelectorAll(".frequency-btn");
  if (frequencyButtons.length) {
    frequencyButtons.forEach(function (btn) {
      btn.addEventListener("click", function () {
        frequencyButtons.forEach(function (b) { b.classList.remove("is-active"); });
        btn.classList.add("is-active");
        var input = document.getElementById("donationFrequency");
        if (input) input.value = btn.getAttribute("data-frequency") || "";
      });
    });
  }

  /* ---- donate: preset amount buttons + custom amount sync ---- */
  var amountButtons = document.querySelectorAll(".amount-btn");
  var customAmount = document.getElementById("customAmount");

  function resetDonateAmounts() {
  ...
  if (amountButtons.length) {
    amountButtons.forEach(function (btn) {
      btn.addEventListener("click", function () {
        amountButtons.forEach(function (b) { b.classList.remove("is-active"); });
        btn.classList.add("is-active");
        if (customAmount) customAmount.value = btn.getAttribute("data-amount") || "";
      });
    });
  }

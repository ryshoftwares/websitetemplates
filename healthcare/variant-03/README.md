...
A calm, restrained marketing site for a community family clinic: clean hairline grids, a single
steel-blue accent, and quiet typography — built to feel dependable rather than flashy.

## Pages

- `index.html` — Home: trust indicators, services overview, patient testimonial
- `about.html` — Our history since 2003, values, milestones and leadership
- `services.html` — Services offered, plus how to become a patient
...
- Sticky header with border-on-scroll
...
Fonts loaded from Google Fonts CDN (Libre Franklin + Karla). No build step, no dependencies.

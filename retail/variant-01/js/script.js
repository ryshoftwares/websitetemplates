...
(function () {
  ...
  var CART_KEY = "marche-cart-count";
  var WISHLIST_KEY = "marche-wishlist";
  ...
  /* ---- shop: search, category/price filters, sort ---- */
  ...
  /* ---- product detail: gallery, variant selectors, quantity stepper, add to cart ---- */
  ...
  if (addToCartBtn) {
    addToCartBtn.addEventListener("click", function () {
      ...
      var qty = qtyField ? clampSafe(qtyField.value) : 1;
      addToCart(qty);

...
(function () {
  ...
  var CART_KEY = "popco-cart-count";
  var WISHLIST_KEY = "popco-wishlist";
  ...
  function renderCartCount(bump) {
    ...
    if (bump) { el.classList.add("is-bumped"); window.setTimeout(function () { el.classList.remove("is-bumped"); }, 320); }
  }
  function addToCart(qty) {
    localStorage.setItem(CART_KEY, String(getCartCount() + qty));

...
A confident, editorial marketing site for a global management consultancy: large serif
headlines, a deep navy and teal palette, and generous, considered spacing.

## Pages

- `index.html` — Home
- `about.html` — About / story, values, timeline, leadership
- `services.html` — Service lines + process
...
```css
:root {
  --primary: #16233f;   /* ink navy */
  --accent:  #2f7d6a;   /* deep teal */
  --background: #f8f6f1;
}
```
